    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          ...
          <ul class="nav nav-sidebar">
            <li class="active"><a href="<?php echo site_url('start/addProblem');?>"><b>ADD A PROBLEM</b></a></li>
          </ul>
          <ul class="nav nav-sidebar">
       ...
       <!-- <?php
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-8 col-md-offset-2 main">
          <h2 class="page-header">Add A New Problem</h2>
           <form id="problemform" class="form-horizontal" role="form" action="<?php echo site_url('start/add_new_problem');?>" method = "post">
            <div>
            ...
            <div>
              ...
              <textarea class="form-control" rows="10" id="comment" name="description" placeholder="Problem description (within 2000 charactars)..."></textarea>
