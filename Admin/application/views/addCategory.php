  ...
  <body>
    ...
    <div class="container">
      <div class="col-sm-9 col-sm-offset-3 col-md-8 col-md-offset-2 main bord"> 
          ...
          <h2 class="sub-header">Add A Category</h2><br><br> 
          <form id="problemform" class="form-horizontal" role="form" action="<?php echo site_url('admin/add_new_category');?>" method = "post">
            <div>
                <h3><span class="label label-primary">New Category Name</span></h3><br>
                <input type="text" class="form-control" name="category" id="usr" placeholder="Category Name..."><br>
            </div>
              <div>
                <br><button type="submit" class="btn btn-success">Add Category</button>
              </div>
          </form>
        </div>
    </div>
