      ...
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <div class="table-responsive">
            <i><span class="text-muted">There are lots of problems in every section. Select one & start solving them...</span></i>
              ...
              <tbody>
                      <?php
                        ...
                        foreach ($sections as $s) {
                          ...
                          <tr>
                            <td></td>
                            <td><a href="; echo site_url('start/func/'.$temp); echo ">".$it.".  ".$s['section_name']."</a></td>
                          </tr>
                          <tr>
                            <td></td>
                            <td></td>
