  ...
  <body>
    ...
    <div class="container">
      <div class="col-sm-9 col-sm-offset-3 col-md-8 col-md-offset-2 main bord"> 
          ...
          <h2 class="sub-header">Add New Admin</h2><br><br> 
          <form id="problemform" class="form-horizontal" role="form" action="<?php echo site_url('admin/add_new_admin');?>" method = "post">
            <div>
                <h3><span class="label label-primary">Username</span></h3><br>
                <input type="text" class="form-control" name="username" id="usr" placeholder="Username..."><br>
            </div>
            <div>
                <h3><span class="label label-primary">Password</span></h3><br>
                <input type="password" class="form-control" name="password" id="usr" placeholder="Password..."><br>
            </div>
              <div>
