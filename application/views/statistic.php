      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li class="active"><a href="<?php echo site_url('start/statistic');?>"><b>Statistics</b></a></li>
          </ul>
          <ul class="nav nav-sidebar">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-8 col-md-offset-2 main">
          <h2 class="page-header">Your Statistics</h2>
          ...
          <div class="table-responsive">
            <table class="table table-striped">
              ...
              <tbody>
                ...
                foreach ($stat as $s) {
                  echo"<tr>
                    <td><b>".$s['cat_name']."</b></td>
                    <td><b><i>".$s['level']."</i><b></td>
                    <td><b>".$s['point']."<b></td>
                  </tr>
                  <tr>
                    <td><br></td>
            ...
            <div col-sm-6 col-md-2 >
              <h4><font color="green">BEGINNER Upto 1000</font></h4><br>
              <h4><font color="green">INTERMEDIATE Upto 2500</font></h4><br>
              <h4><font color="green">EXPERT Above 2500</font></h4><br>
            </div>
          </div>
